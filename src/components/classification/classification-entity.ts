import { Attributes, Category, Choices, ContentSection, CssFieldMappings, DataModel, DataType, Description, DisplayName, KnownFieldTypes, Margins, MaxLength, Model, Placeholder, Required, WidgetEntity } from 'sitefinity-widget-designers/decorators';
